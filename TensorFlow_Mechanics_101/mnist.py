...
def inference(images, hidden1_units, hidden2_units):
    ...
    Args:
        ...
        hidden2_units: Size of seconde hidden layer.
...
def loss(logits, labels):
    ...
    Args:
        logits: Logits tensor, float - [batch_size, NUM_CLASSESE]
...
def training(loss, learning_rate):
    ...
    Args:
        ...
        learning rate: The learning rate to use for gradient descent.
...
def evaluation(logits, labels):
    ...
    Args:
        logits: Logits tesnor, float - [batch_size, NUM_CLASSES]
        labels: Labels tensor, int32 - [batch_size], with values in the range [0, NUM_CLASSES)

    Returns:
        A scalar int32 tensor with the number of examples (out of batch_size) that were
        predicted correctly.
    """
